       ...
       <div className="portfolio-top" id="myWork">
         <div className="container">
          ...
          <div className="row">
            ...
            <Zoom><p className="body">Using the LCBO’s API, this site helps users pick a craft beer while delivering information about Toronto’s craft breweries.</p></Zoom>
            <div className="spacing-3"></div>
          </div>
